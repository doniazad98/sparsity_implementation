...
def k_nearest_neighbors(test, train, user_id, item_id, k, distance):
    ...
    #sorted_list = sorted(similarity, key=lambda x: (-x[1]))
...
def evaluate_algorithm_dataframe(dataset,algorithm, distance, dataset_name, k):
    ...
    # ----------------Big dataset
    train_set, test_set = train_test_split(dataset, test_size=0.2, random_state=25)
    ...
    print("pairs={} , actual={}".format(pairs,actual))
...
if __name__ == '__main__':
    ...
    dataset3 = saved[3]
    dataset4 = saved[4]
    for dataset in [dataset0,dataset1,dataset2,dataset3,dataset4]:
